...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.mlb_data(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.name_data(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.nfl_data(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.nfl_stadium_data(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.person(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.player(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.seat(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.seat_type(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.sporting_event(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.sporting_event_ticket(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.sport_division(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.sport_league(
sport_type_name CHARACTER VARYING(15) NOT NULL,
short_name CHARACTER VARYING(10) NOT NULL,
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.sport_location(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.sport_team(
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.sport_type(
name CHARACTER VARYING(15) NOT NULL,
description CHARACTER VARYING(120)
);
...
CREATE UNLOGGED TABLE IF NOT EXISTS dms_sample.ticket_purchase_hist(
